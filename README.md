...
|---|---|
| Корректность и пользовательский сценарий | **103 теста пройдены**, включая загрузку XLSX → пересчёт остатка → утверждённый Excel |
...
- **Денежный эффект и сокращение ручного времени пока не измерены.** Для них подготовлен [протокол контрольного пилота](docs/measured-effect.md#как-измерить-бизнес-эффект).
