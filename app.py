...
orders_tab,detail_tab,anomaly_tab,backtest_tab,history_tab,quality_tab,evidence_tab,scenario_tab=st.tabs(['Рекомендации','Почему столько','Разовые продажи','Проверка прогноза','История','Качество данных','Проверка кейса','Сценарии'])
with scenario_tab:
